...
namespace SadConsole.Examples
{
    ...
    internal class AsciiArt : ScreenSurface
    {
    ...
    internal class AsciiGraphicsTitlePage : AsciiArt
    {
    ...
    internal record Description(string Title, string Summary)
    {
        public string FontName { get; set; } = string.Empty;
    }

    internal class AnsiArt : AsciiArt
    {
    ...
    internal class PlaysciiArt : AsciiArt
    {
        public static readonly Dictionary<string, Description> Descriptions = new()
            {
