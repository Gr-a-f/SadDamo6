...
namespace SadConsole.Examples
{
    ...
    internal class AnimationSlide : ScreenSurface
    {
    ...
    internal class AnimatedFlip : AnimationSlide
    {
        public AnimatedFlip() : base()
        {
            ...
            Add(AnimatedScreenObject.FromImage("Acrobatic Flip", "Res/Images/Animations/flip_anim.png", (9, 3), TimeSpan.FromSeconds(0.5d),
    ...
    internal class AnimatedSkater : AnimationSlide
    {
    ...
    /// </summary>
    internal class AnimatedGlobe : AnimationSlide
    {
    ...
    internal class AnimatedSkull : AnimationSlide
    {
        public AnimatedSkull() : base()
        {
            Surface.DefaultBackground = new Color(150, 150, 150);
            Surface.Clear();

            //skull_anim is an animation with black pixels
            //skull_anim_g is the same animation but changed to grey
            //I also changed the background of thick_square_8x8.png from black to transparent,
            // but the black pixels are still transparent

            Add(AnimatedScreenObject.FromImage("Skull death screen", "Res/Images/Animations/skull_anim_g.png", (6, 2), TimeSpan.FromSeconds(0.5d),
                pixelPadding: (1, 1), frameStartAndFinish: (0, 11), font: Game.Instance.LoadFont("Res/Fonts/thick_square_8x8.font")));
            
            PrintInfo("Custom", Children[0]);
        }
    }
}
